...
module.exports.sockets = { 
  ...
  onConnect: function(session, socket) {
      ...
      socket_ids.push(socketId);
     
      //sails.io.sockets.socket(socket_ids[1]).emit("hello","ssssss");
      socket.on("users",function(data){
           sails.io.sockets.emit("users_updated",data);
      });

      socket.on("screen",function(data){
           console.log('img');
           sails.io.sockets.emit("screen_img",data);
      });
  },
